...
public class PureStorageModule extends AbstractCloupiaModule
{
    ...
    public AbstractTask[] getTasks()
    {
        ...
        AbstractTask[] tasks = new AbstractTask[25];
    ...
    {
        CloupiaReport[] reports = new CloupiaReport[12];
        ...
        reports[7] = new ArrayReport();
        reports[8] = new NetworkReport();
        reports[9] = new HostConnectionReport();
        reports[10] = new FcPortsReport();
        reports[11] = new IqnPortsReport();

...
public class ConnectVolumeHostGroup extends CloupiaPageAction {
	private static Logger logger = Logger.getLogger(ConnectVolumeHostGroup.class);
	
	private static final String formId = "psucs.connect.volume.hostgroup.form";
	private static final String ACTION_ID = "psucs.connect.volume.hostgroup.action";
	...
	public void definePage(Page page, ReportContext context) {
		...
		page.bind(formId, ConnectVolumeHostGroupForm.class);
	...
	public void loadDataToPage(Page page, ReportContext context, WizardSession session) throws Exception {
		// TODO Auto-generated method stub
		ConnectVolumeHostGroupForm form = (ConnectVolumeHostGroupForm) page.unmarshallToSession(formId);
	...
	public int validatePageData(Page page, ReportContext context, WizardSession session) throws Exception {
		// TODO Auto-generated method stub
		 ...
		 ConnectVolumeHostGroupForm config = (ConnectVolumeHostGroupForm) page.unmarshallToSession(formId);
		...
		if (page.isPageSubmitted())
        {
			try{
		        ...
		        logger.info("Starting connecting volume(s) to hostgroup " + hostGroupName +
		        ...
		        for(int i=0; i<volumeNameList.length; i++)
		        {
		            ...
		            {
		                logger.info(volumeName + " has already been connected to host group" + hostGroupName);
		                continue;
		            }
		        ...
		        logger.info("Successfully Connected volume(s) to hostgroup " + hostGroupName + " on Pure FlashArray [" + flashArrayAccount.getManagementAddress() + "]");
		      String hostGroupIdentity =accountName+"@"+hostGroupName;
		        ...
		        logger.info("Hosts Id :"+ hostGroupConfig.get(0).getId());
                ...
                page.setPageMessage("Successfully connected volume(s) to hostgroup " + hostGroupName + "on Pure FlashArray [" + flashArrayAccount.getManagementAddress() + "]");

...
@PersistenceCapable(detachable = "true", table = "child_host_inventory_config")
public class ChildHostInventoryConfig
{

    static Logger logger = Logger.getLogger(ChildHostInventoryConfig.class);

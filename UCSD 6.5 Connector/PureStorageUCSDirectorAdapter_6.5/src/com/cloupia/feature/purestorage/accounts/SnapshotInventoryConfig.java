...
@PersistenceCapable(detachable = "true", table = "snapshot_inventory_config")
public class SnapshotInventoryConfig
{

    static Logger logger = Logger.getLogger(SnapshotInventoryConfig.class);

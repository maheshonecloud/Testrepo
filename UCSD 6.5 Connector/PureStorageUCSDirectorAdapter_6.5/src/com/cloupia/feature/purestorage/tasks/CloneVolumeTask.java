...
public class CloneVolumeTask extends AbstractTask
{
	static Logger logger = Logger.getLogger(CloneVolumeTask.class);
    ...
    public void executeCustomAction(CustomActionTriggerContext context, CustomActionLogger actionlogger) throws Exception
    {
		...
		CloneVolumeTaskConfig config = (CloneVolumeTaskConfig) context.loadConfigObject();
        ...
        actionlogger.addInfo("Volume Name is : "+volumeName+" and Cloned Volume Name is : "+volumePreName);
    	logger.info("Volume Name is : "+volumeName+" and Cloned Volume Name is : "+volumePreName);
      	CLIENT.volumes().create(volumePreName, volumeName);
    	
        PureVolume volume =  CLIENT.volumes().get(volumePreName);
      
        	String outVolName=volume.getName();
        	String outSer=volume.getSerial();
        	String connVol=accountName+"@"+volumeName;	
            ...
            actionlogger.addInfo("Successfully Cloned Volume " + volumePreName + " on Pure FlashArray [" + flashArrayAccount.getManagementAddress() + "]");
        	...
        	actionlogger.addInfo("Volume Identities as Output is saved");
                ...
                String description="FlashArray Volume is created. Details are : Account Name = "+config.getAccountName()+" , New Volume Name = "+ volumePreName+" , Source Volume Name = "+volumeName;
	...
	public TaskConfigIf getTaskConfigImplementation() {
		...
		return new CloneVolumeTaskConfig();
	}

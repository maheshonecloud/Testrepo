...
@PersistenceCapable(detachable = "true", table = "psucs_remove_a_volume_protection_config")
public class RemoveVolumeProtectionGroupTaskConfig implements TaskConfigIf
{
    ...
    public RemoveVolumeProtectionGroupTaskConfig(){}

    public RemoveVolumeProtectionGroupTaskConfig(AddVolumeProtectionGroupTaskConfig config)
    {
        this.accountName = config.getAccountName();
        this.volumeName = config.getVolumeName();
        this.protectionGroup = config.getProtectionGroup();
    }

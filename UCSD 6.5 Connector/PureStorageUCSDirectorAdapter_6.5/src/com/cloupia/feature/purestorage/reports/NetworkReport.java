...
public class NetworkReport extends CloupiaReportWithActions
{

    private static Logger logger = Logger.getLogger(NetworkReport.class);
    ...
    {
        return NetworkReportImpl.class;
    }
    ...
    {
        return "com.purestorage.flasharray.network";
    }
    ...
    {
        return PureConstants.NETWORK_MENU_LOCATION;
    }
